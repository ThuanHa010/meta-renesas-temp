...
SRC_URI_append = " \
    file://0001-rcar_gen3-drivers-qos-add-split-linear-2ch-setting.patch \
"
...
ATFW_OPT_r8a7795 = "LSI=H3 RCAR_DRAM_SPLIT=1 RCAR_DRAM_LPDDR4_MEMCONF=0 ${ATFW_OPT_LOSSY} ${ATFW_OPT_BOOTMODE}"
ATFW_OPT_r8a7796 = "LSI=M3 RCAR_DRAM_SPLIT=4  ${ATFW_OPT_LOSSY} ${ATFW_OPT_BOOTMODE}"
ATFW_OPT_r8a77965 = "LSI=M3N ${ATFW_OPT_LOSSY} ${ATFW_OPT_BOOTMODE}"
ATFW_OPT_r8a77990 = "LSI=E3 RCAR_SA0_SIZE=0 RCAR_AVS_SETTING_ENABLE=0 RCAR_DRAM_DDR3L_MEMCONF=0 RCAR_DRAM_DDR3L_MEMDUAL=0 ${ATFW_OPT_BOOTMODE}"
ATFW_OPT_r8a77995 = "LSI=D3 RCAR_SA0_SIZE=0 RCAR_AVS_SETTING_ENABLE=0 PMIC_ROHM_BD9571=0 RCAR_SYSTEM_SUSPEND=0 DEBUG=0 ${ATFW_OPT_BOOTMODE}"
