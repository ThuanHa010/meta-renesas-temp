...
BRANCH = "${@oe.utils.conditional("USE_SAFE_RENDERING", "1", "rcar-5.1.4.rc3/saferendering.rc9", "v5.10.194/rcar-5.3.1.1", d)}"
SRCREV = "${@oe.utils.conditional("USE_SAFE_RENDERING", "1", \
    "e2037726e5f6c3d6de6bc7d78b50ea9e2248a00d", \
    "bcc849675f7936cf0546f5fe125d97dd04df98e1", d)}"
...
SRC_URI_append = " \
    file://AsymetricalMem-2gb-4gb-linear-split.patch \
"
